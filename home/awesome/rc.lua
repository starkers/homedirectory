...
globalkeys = my_table.join(
    ...
    -- Standard program
    awful.key({ modkey,           }, "Return", function () awful.spawn('tmux-term') end,
    ...
    -- awful.key({ altkey, "Shift"   }, "Up",     function () awful.tag.incmwfact( 0.05)          end,
    ...
    -- awful.key({ altkey, "Shift"   }, "Down",     function () awful.tag.incmwfact(-0.05)          end,
    ...
    awful.key({ altkey }, ",", function ()
        ...
        {description = "select from previous clipboard", group = "launcher"})
...
awful.util.spawn("run_keybase -a")
awful.spawn.with_shell("feh --bg-fill /home/starkers/.config/i3/wallpapers/default")
-- awful.spawn.with_shell(string.format("pgrep -u $USER -fx '%s' > /dev/null || (%s)", cmd, cmd))
